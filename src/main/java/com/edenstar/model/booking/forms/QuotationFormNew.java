...
String myvar ="<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">"+
		...
		"<p><img alt=\"eden star logo\" height=\"200\" style=\"display: block; margin-left: auto; margin-right: auto;\" width=\"200\"/></p>"+
		"</div>"+
		...
		"<p style=\"font-size: 14px; line-height: 55px; text-align: center; margin: 0;\"><span style=\"font-size: 46px;\"><strong><em><span style=\"line-height: 55px; font-size: 46px;\">Eden Star</span></em></strong></span></p>"+
		"</div>"+
		"</div>"+
		...
		"<div style=\"color:#555555;font-family:'Ubuntu', Tahoma, Verdana, Segoe, sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;\">"+
		"<div style=\"font-family: 'Ubuntu', Tahoma, Verdana, Segoe, sans-serif; font-size: 12px; line-height: 14px; color: #555555;\">"+
		"<p style=\"font-size: 14px; line-height: 16px; text-align: center; margin: 0;\"><strong><span style=\"font-size: 20px; line-height: 24px;\">Kiosk Quotation</span></strong></p>"+
		"</div>"+
		"</div>"+
		"<!--[if mso]></td></tr></table><![endif]-->"+
		"<div style=\"font-size:16px;text-align:center;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif\">"+
